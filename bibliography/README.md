...
- [Shu:1999](pdf/1999-Shu.pdf) **High Order ENO and WENO Schemes for Computational Fluid Dynamics** (*1999*)
	C. Shu
...
- [Hochbruck:2010](pdf/2010-Hochbruck.pdf) **Exponential integrators** (*2010*)
	M. Hochbruck, A. Ostermann
	*Acta Numerica*
- [Motamed:2010](pdf/2010-Motamed.pdf) **On the Linear Stability of the Fifth-Order WENO Discretization** (*2010*)
	M. Motamed, C. B. Macdonald, S. J. Ruuth
	*Journal of Scientific Computing*
- [Degond:2010](pdf/2010-Degond.pdf) **A multiscale kinetic-fluid solver with dynamic localization of kinetic effects** (*2010*)
...
- [Crestetto:2012a](pdf/2012a-Crestetto.pdf) **Optimisation de méthodes numériques pour la physique des plasmas. Application aux faisceaux de particules chargées** (*2012*)
	A. Crestetto
	 
- [Crestetto:2012b](pdf/2012b-Crestetto.pdf) **Kinetic/Fluid Micro-Macro Numerical Schemes for Vlasov-Poisson-BGK Equation Using Particles** (*2012*)
	A. Crestetto, N. Crouseilles, M. Lemou
	*Kinetic and Related Models*
- [Balac:2013b](pdf/2013b-Balac.pdf) **Mathematical analysis of adaptive step-size techniques when solving the nonlinear Schrödinger equation for simulating light-wave propagation in optical fibers** (*2013*)
	S. Balac, A. Fernandez
	 
- [Balac:2013a](pdf/2013a-Balac.pdf) **Embedded Runge-Kutta scheme for step-size control in the interaction picture method** (*2013*)
	S. Balac, F. Mahé
...
- [Filbet:2014](pdf/2014-Filbet.pdf) **A hierachy of hybrid numerical methods for multi-scale kinetic equations** (*2014*)
	F. Filbet, T. Rey
	*Journal of Scientific Computing*
- [Boyer:2014](pdf/2014-Boyer.pdf) **Aspects théoriques et numériques de l'équation de transport** (*2014*)
	F. Boyer
	 
- [Ketcheson:2015](pdf/2015-Ketcheson.pdf) **NodePy (Numerical ODEs in Python) softwate version 0.6** (*2015*)
	D. Ketcheson
...
- [Li:2016](pdf/2016-Li.pdf) **High order finite volume WENO schemes for Euler equations under gravitational fields** (*2016*)
	G. Li, Y. Xing
	*Journal of Computational Physics*
- [Meurer:2017](pdf/2017-Meurer.pdf) **SymPy: symbolic computing in Python** (*2017*)
...
- [Filbet:2018](pdf/2018-Filbet.pdf) **A hybrid discontinuous Galrkin scheme for mulit-scale kinetic equations** (*2018*)
	F. Filbet, T. Xiong
	*Journal of Computational Physics*
- [Holderied:2018](pdf/2018-Holderied.pdf) **Electron Hybrid model for R/L-waves in cold plasmas** (*2018*)
	F. Holderied
	 
- [Isherwood:2018](pdf/2018-Isherwood.pdf) **Strong Stability Preserving Integrating Factor Runge-Kutta Methods** (*2018*)
...
- [Banks:2019](pdf/2019-Banks.pdf) **High order accurate conservative finite difference methods for Vlasov equations in 2D+2V** (*2019*)
